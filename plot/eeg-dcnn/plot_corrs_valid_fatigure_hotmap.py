...
for ly in range(8):
    for sub in range(18):
        ...
        corrs2[sub, ly] = np.array(h5py.File("../../eeg-dcnn/corrs/random_fatigue/ly" + str((ly+1)*2) + "_sub" + str(sub+1) + ".h5", "r")["corrs"])
...
figpath = "results/hotmap/fatigue_valid_similarity.jpg"
...
for ly in range(8):
    for sub in range(18):
        ...
        corrs2[sub, ly] = np.array(h5py.File("../../eeg-dcnn/corrs/random_fatigue_3faces/ly" + str((ly+1)*2) + "_sub" + str(sub+1) + ".h5", "r")["corrs"])
...
plt.xlabel("Time (s)", fontsize=20)
plt.ylabel("DCNN Layer", fontsize=20)
figpath = "results/hotmap/fatigue_3faces_valid_similarity.jpg"
plt.savefig(figpath, dpi=2000)
plt.show()